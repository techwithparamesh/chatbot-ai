  ...
  return (
    <section id="testimonials" className="py-10 sm:py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight mb-3" data-testid="text-testimonials-title">
            ...
            >
              <Card className="h-full hover-elevate transition-all duration-300 overflow-visible" data-testid={`card-testimonial-${index + 1}`}>
                <CardContent className="p-4 sm:p-6 lg:p-8">
                  ...
                  <blockquote className="text-sm sm:text-base text-foreground mb-4 sm:mb-6 leading-relaxed line-clamp-3 sm:line-clamp-none" data-testid={`text-testimonial-${index + 1}-quote`}>
                    "{testimonial.quote}"
                  </blockquote>
